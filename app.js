...
//var timerour.innerText = timeourRemaining;
//var timernotour.innerText = timenotourRemaining;
...
//		readDiagonals("computer");
	...
	function readDiagonals() {
			...
			if (a.owner == e.owner && i.owner == e.owner) {
				gameover = true;
				announceWinner(e.owner);
			} 
			if (c.owner == e.owner && g.owner == e.owner) {
				gameover = true;
				announceWinner(e.owner);
			}
	...
	function readSet(setNumber, setType) {
		...
		if (criteria[0].owner == "computer" && criteria[0].owned && criteria[1].owned && criteria[2].owned && criteria[0].owner == criteria[1].owner && criteria[1].owner == criteria[2].owner) {
			gameover = true;
